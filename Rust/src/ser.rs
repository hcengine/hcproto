use crate::{
    encode::{
        append_and_align, encode_bool, encode_field, encode_number, encode_str_idx, encode_str_raw,
        encode_sure_type, encode_type, encode_varint,
    },
    Buffer, HpError, Value,
    ValueType::{self, Raw},
};
...
impl<'s> ser::Serializer for &'s mut Serializer {
    ...
    type SerializeTupleVariant = Variant<'s>;
    type SerializeMap = Self;
    type SerializeStruct = Self;
    type SerializeStructVariant = Variant<'s>;
    ...
    fn serialize_tuple_variant(
        ...
        Err(ser::Error::custom(
            "serialize_tuple_variant is not supported",
        ))
    }
...
impl<'s> ser::SerializeTupleVariant for Variant<'s> {
    type Ok = ();
    type Error = HpError;
...
impl<'s> ser::SerializeStructVariant for Variant<'s> {
    type Ok = ();
    type Error = HpError;
